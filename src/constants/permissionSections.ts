...
export const DEFAULT_APP_VISIBILITY: Record<UserRole, Record<string, boolean>> = {
  ...
  hr: {
    ...
    'user-management': false, 'defect-tracker': false,
  },
  manager: {
  ...
  marketing: {
    ...
    'training': true, 'documentation': true,
